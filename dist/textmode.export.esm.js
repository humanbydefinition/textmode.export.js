...
class Q {
  $downloadFile(t, e, r) {
    try {
      const a = this._sanitizeFilename(e, r), i = URL.createObjectURL(t), n = document.createElement("a");
      n.href = i, n.download = a, n.style.display = "none", n.rel = "noopener", document.body.appendChild(n), n.click(), document.body.removeChild(n), URL.revokeObjectURL(i);
    } catch (a) {
      console.error("[textmode-export] Failed to download file:", a);
    }
  }
  _sanitizeFilename(t, e) {
    let r = t;
    r && r.trim() || (r = this._generateDefaultFilename());
    let a = r.trim().replace(/[<>:"/\\|?*]/g, "_").replace(/\s+/g, "_").replace(/_{2,}/g, "_").replace(/^_+|_+$/g, "").substring(0, 255) || this._generateDefaultFilename();
    return e && (a.toLowerCase().endsWith(e.toLowerCase()) || (a += e)), a;
  }
...
class gt {
  ...
  $saveSVG(t, e = {}) {
    new Q().$downloadFile(new Blob([this.$generateSVG(t, e)], { type: "image/svg+xml;charset=utf-8" }), e.filename, ".svg");
  }
}
const lt = { png: "image/png", jpg: "image/jpeg", webp: "image/webp" }, at = { png: ".png", jpg: ".jpg", webp: ".webp" };
class bt {
  _applyDefaultOptions(t) {
    return { format: t.format ?? "png", scale: Math.abs(t.scale ?? 1), filename: t.filename };
  }
  _validateOptions(t) {
    if (!(t.format in lt)) throw new Error(`Saving '${t.format}' files is not supported`);
  }
  ...
  async $saveImage(t, e = {}) {
    ...
    new Q().$downloadFile(a, r.filename, at[r.format]);
  }
  async $copyImageToClipboard(t, e = {}) {
    ...
    const r = this._applyDefaultOptions(e);
    this._validateOptions(r);
    const a = await this.$generateImageBlob(t, r), i = new ClipboardItem({ [lt[r.format]]: a });
...
class vt {
  ...
  _createTXTContent(t, e) {
    const r = new At(), a = t.layers.base.drawFramebuffer, i = r.$extractFramebufferData(a), n = [];
    let c = 0;
    for (let l = 0; l < t.grid.rows; l++) {
      let p = "";
      for (let o = 0; o < t.grid.cols; o++) {
        const d = 4 * c, u = r.$getCharacterIndex(i.characterPixels, d);
        p += t.font.characters[u]?.character || e.emptyCharacter, c++;
      }
      e.preserveTrailingSpaces || (p = p.trimEnd()), n.push(p);
    }
    return n.join(`
`);
  }
  ...
  $saveTXT(t, e = {}) {
    ...
    new Q().$downloadFile(i, r.filename, ".txt");
  }
}
class jt {
  _canvas;
    ...
    return await new Promise((l, p) => {
      ...
      const x = () => {
        ...
        if (u >= c) h(o);
          ...
          const _ = e.scale, v = Math.max(1, Math.round(t.width * _)), f = Math.max(1, Math.round(t.height * _));
          ...
          const C = this._ctx;
          C.imageSmoothingEnabled = !1, C.clearRect(0, 0, v, f), C.drawImage(t, 0, 0, t.width, t.height, 0, 0, v, f);
          const S = { imageData: C.getImageData(0, 0, v, f), width: v, height: f, delayMs: n };
...
var Pt = Object.defineProperty, Qt = (s) => Pt(s, "__esModule", { value: !0 }), Xt = (s, t) => () => (t || s((t = { exports: {} }).exports, t), t.exports), Yt = (s, t) => {
  ...
  function c(d, u) {
    let [m, x, h] = d, [g, _, v] = u, f = t(m, x, h) - t(g, _, v), C = e(m, x, h) - e(g, _, v), S = r(m, x, h) - r(g, _, v), E = i(d) - i(u);
    return f * f * 0.5053 + C * C * 0.299 + S * S * 0.1957 + E * E;
  }
  function l(d, u) {
...
function te(s, t, e, r, a, i, n, c) {
  ...
  i.fill(0), c.fill(0), L();
  let o = 0, d = 0, u = p + 1, m = u, x = !1, h = m, g = D(h), _ = 1 << u - 1, v = _ + 1, f = _ + 2, C = 0, S = e[0], E = 0;
  ...
  function V(k) {
    ...
    if (n[y] === R) S = c[y];
      ...
      O(S), S = k, f < 1 << Z ? (c[y] = f++, n[y] = R) : (L(), f = _ + 2, x = !0, O(_));
    }
  }
  function B() {
...
function yt(s, t, e) {
  for (var r = 0, a = 1e100, i = s[t], n = i.cnt, c = (i.ac, i.rc), l = i.gc, p = i.bc, o = i.fw; o != 0; o = s[o].fw) {
    ...
    if (!(u >= a)) {
      var m = 0;
      !((m += u * it(s[o].rc - c)) >= a) && !((m += u * it(s[o].gc - l)) >= a) && !((m += u * it(s[o].bc - p)) >= a) && (a = m, r = o);
    }
  }
  i.err = a, i.nn = r;
}
...
function ae(s, t, e) {
  ...
  for (it(t) / x < 0.022 && (l = !1), h = 0; h < x - 1; ++h) o[h].fw = h + 1, o[h + 1].bk = h, l && (o[h].cnt = Math.sqrt(o[h].cnt));
  var _, v, f;
  ...
  for (h = 0; h < S; ) {
    for (var E; ; ) {
      ...
      for (E.mtm == u ? A = m[1] = m[m[0]--] : (yt(o, A), E.tm = h), C = o[A].err, v = 1; (f = v + v) <= m[0] && (f < m[0] && o[m[f]].err > o[m[f + 1]].err && f++, !(C <= o[_ = m[f]].err)); v = f) m[v] = _;
      m[v] = A;
    }
...
function le(s = {}) {
  ...
  return { reset() {
    ...
    if (e ? c || (C = !0, l(), c = !0) : C = !!u.first, o = Math.max(0, Math.floor(o)), d = Math.max(0, Math.floor(d)), C) {
      ...
      ce(r, o, d, g, v), _t(r, g), _ >= 0 && ue(r, _);
    }
    let S = Math.round(h / 10);
    de(r, f, S, m, x);
    let E = !!g && !C;
    pe(r, o, d, E ? g : null), E && _t(r, g), he(r, p, o, d, v, a, i, n);
  } };
  function l() {
    Rt(r, "GIF89a");
  }
  ...
  async $saveGIF(t = {}) {
    ...
    try {
      ...
      for (let o = 0; o < i.length; o++) {
        const d = i[o], { width: u, height: m, imageData: x, delayMs: h } = d, g = new Uint32Array(x.data.buffer.slice(0)), _ = ae(g, 256, {}), v = oe(g, _);
      ...
      new Q().$downloadFile(new Blob([p], { type: "image/gif" }), r.filename, ".gif"), a?.({ state: "completed", totalFrames: r.frameCount });
    } catch (i) {
    ...
    let c = function(l, p) {
      return function(o) {
        ...
        function R() {
          ...
          let w = new l(y + 64 * f.length), F = (function(I) {
            return { id: 524531317, data: [{ id: 231, data: Math.round(I.timecode) }] };
          })({ timecode: Math.round(C) });
          for (let I = 0; I < f.length; I++) F.data.push(k(f[I]));
          var $, M, U;
          n(w, B.pos, F), B.write(w.getAsDataArray()), $ = 1, M = Math.round(C), U = F.offset, V.push({ id: 187, data: [{ id: 179, data: M }, { id: 183, data: [{ id: 247, data: $ }, { id: 241, data: D(U) }] }] }), f = [], C += S, S = 0;
        }
        this.addFrame = function(y, w, F) {
          ...
          $ = F || (typeof w == "number" ? w : o.frameDuration), o.transparent && (w instanceof HTMLCanvasElement || typeof w == "string" ? U = w : M.hasAlpha && (U = (function(I) {
            ...
            for (let nt = 3; nt < zt; nt += 4) {
              let st = q[nt];
              J[K++] = st, J[K++] = st, J[K++] = st, J[K++] = 255;
            }
            return _.putImageData(v, 0, 0), g;
          })(y))), (function(I) {
            I.trackNumber = 1, I.timecode = Math.round(S), f.push(I), S += I.duration, S >= 5e3 && R();
          ...
          this.pos += u.length, this.length = Math.max(this.length, this.pos), i = i.then(function() {
            if (c) return new Promise(function(x, h) {
              p(u.data).then(function(g) {
                let _ = 0, v = Buffer.from(g.buffer), f = function(C, S, E) {
                  _ += S, _ >= E.length ? x() : e.write(c, E, _, E.length - _, u.offset + _, f);
                };
                e.write(c, v, 0, v.length, u.offset, f);
              });
            });
...
class Ce {
  ...
  async $saveWEBM(t = {}) {
    ...
    try {
      ...
      new Q().$downloadFile(a, r.filename, ".webm");
    } catch (a) {
...
class ut extends Y {
  ...
  setRecordingState(t, e) {
    ...
    const r = t === "recording" || t === "encoding";
    switch (this.frameCountInput.inputElement.disabled = r, this.frameRateInput.inputElement.disabled = r, this.scaleInput.inputElement.disabled = r, this.repeatInput.inputElement.disabled = r, t) {
      ...
      case "encoding":
        if (e?.totalFrames) {
          const a = e.frameIndex ?? 0;
          this.status.setMessage(`encoding ${a}/${e.totalFrames}`, "active");
  ...
  handleProgress(t) {
    if (t.state !== "recording" && t.state !== "encoding" || !t.totalFrames) t.state === "completed" ? this.status.setMessage("GIF saved successfully", "active") : t.state === "error" && this.status.setMessage(t.message ?? "failed to export GIF", "alert");
    else {
      const e = t.state === "recording" ? "recording" : "encoding";
      this.status.setMessage(`${e} ${t.frameIndex ?? 0}/${t.totalFrames}`, "active");
    }
  }
  applyDefaults() {
...
const ot = "textmode-export-range-input", Me = `${ot}__field`, $e = `${ot}__tooltip`, ct = `${ot}__tooltip--visible`, rt = (s, t) => {
...
class We extends Y {
  formatSelect = this._manageComponent(new mt({ id: "textmode-export-image-format", options: [{ value: "png", label: `PNG (${at.png})` }, { value: "jpg", label: `JPG (${at.jpg})` }, { value: "webp", label: `WEBP (${at.webp})` }], defaultValue: "png" }));
