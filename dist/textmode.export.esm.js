...
class ge {
  ...
  $generateSVG(e, t = {}) {
    const r = new We(), a = new He(), i = e.layers.base.drawFramebuffer;
    if (!i) throw new Error("No draw framebuffer available for SVG export");
    const n = r.$extractSVGCellData(r.$extractFramebufferData(i), e.grid), c = a.$generateSVGContent(n, e.grid, e.font, this._applyDefaultOptions(t));
    return a.$optimizeSVGContent(c);
  }
  $saveSVG(e, t = {}) {
...
var Pe = Object.defineProperty, Qe = (s) => Pe(s, "__esModule", { value: !0 }), Xe = (s, e) => () => (e || s((e = { exports: {} }).exports, e), e.exports), Ye = (s, e) => {
  ...
  function c(d, u) {
    let [m, x, h] = d, [g, _, v] = u, f = e(m, x, h) - e(g, _, v), C = t(m, x, h) - t(g, _, v), S = r(m, x, h) - r(g, _, v), E = i(d) - i(u);
...
function et(s, e, t, r, a, i, n, c) {
  ...
  i.fill(0), c.fill(0), L();
  let o = 0, d = 0, u = p + 1, m = u, x = !1, h = m, g = D(h), _ = 1 << u - 1, v = _ + 1, f = _ + 2, C = 0, S = t[0], E = 0;
            ...
            if (c) return new Promise(function(x, h) {
              p(u.data).then(function(g) {
                let _ = 0, v = Buffer.from(g.buffer), f = function(C, S, E) {
                  _ += S, _ >= E.length ? x() : t.write(c, E, _, E.length - _, u.offset + _, f);
                };
